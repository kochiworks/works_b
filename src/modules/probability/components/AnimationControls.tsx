import { SPEED_LABELS } from '../hooks/useTrialAnimation'
import type { AnimationSpeed } from '../hooks/useTrialAnimation'
    ...
    <div className="animation-panel">
      <div className="animation-row">
        ...
        <span className="animation-progress-label">
          {revealed.toLocaleString('ko-KR')} / {total.toLocaleString('ko-KR')}회
        </span>
      </div>
